class SimpleWebsite:
    ...
    def handle_request(self, request_headers, request_data):
        ...
        if path in self.routes:
            ...
            return route_handler(method, request_data)
        else:
            return self.not_found(method, request_data)
    ...
    def json_response(self, method, body):
    ...
    def html_response(self, method, body):
    ...
    def not_found(self, method, body):
